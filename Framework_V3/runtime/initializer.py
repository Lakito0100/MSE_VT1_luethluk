import numpy as np
from Framework_V3.models.Frostmodell_V1 import Frostmodell_Edge, Frostmodell_Finn_and_Tube
...
def init_fields(cfg, st, gs):
    ...
    st.w_ft[:] = Frostmodell_Finn_and_Tube.w_sat_coolprop(cfg.T_w,cfg.p_a)
