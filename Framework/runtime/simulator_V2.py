...
class Simulator:
    ...
    def run(self, cfg, geom, gs, model):
        ...
        while t <= gs.t_end:
            ...
            #input_cfg.T_a = dynamic_models.T_a_profile(t, 20.0, 5.0, 4*60.0, 120.0)
            input_cfg.w_amb = dynamic_models.w_amb_profile(t,input_cfg.T_a,input_cfg.p_a,0.0,0.8,4*60.0,20.0)
